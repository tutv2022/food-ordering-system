...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public void process(PaymentResponse paymentResponse) {
        ...
        Optional<OrderPaymentOutboxMessage> orderPaymentOutboxMessage =
        ...
        paymentOutboxHelper.save(getUpdatedPaymentOutboxMessage(orderPaymentOutboxMessage.get(), orderPaidEvent.getOrder().getOrderStatus(), sagaStatus));
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        if (orderPaymentOutboxMessageResponse.isEmpty()) {
            log.info("An outbox message with saga id: {} is already rollbacked!", paymentResponse.getSagaId());
            return;
        }
