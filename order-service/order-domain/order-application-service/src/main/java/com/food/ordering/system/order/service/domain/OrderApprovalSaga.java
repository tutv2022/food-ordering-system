...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void process(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        Optional<OrderApprovalOutboxMessage> approvalOutboxMessageBySagaIdAndSagaStatus = approvalOutboxHelper.getApprovalOutboxMessageBySagaIdAndSagaStatus(
        ...
        Order order = approvedOrder(restaurantApprovalResponse);
    ...
    private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(String sagaId,
        ...
        if (paymentOutboxMessageBySagaIdAndSagaStatus.isEmpty()) {
            throw new OrderDomainException("OrderPaymentOutboxMessage can't be found in " +
    ...
    private Order approvedOrder(RestaurantApprovalResponse restaurantApprovalResponse) {
