...
public class PaymentDomainServiceImpl implements PaymentDomainService{
    ...
    @Override
    public PaymentEvent validateAndInitiatePayment(Payment payment, CreditEntry creditEntry, List<CreditHistory> creditHistoryList, List<String> failureMessages,
    ...
    private void validateCreditHistory(CreditEntry creditEntry, List<CreditHistory> creditHistoryList, List<String> failureMessages) {
        ...
        Money totalDeditHistory = getTotalHistoryAmount(creditHistoryList, TransactionType.DEBIT);

        if (totalDeditHistory.isGreaterThan(totalCreditHistory)) {
        ...
        if ( !creditEntry.getTotalCreditAmount().equals(totalCreditHistory.substract(totalDeditHistory))) {
    ...
    private void substractCreditEntry(Payment payment, CreditEntry creditEntry) {
        creditEntry.substractCreateAmount(payment.getPrice());
    }
    ...
    @Override
    public PaymentEvent validateAndCancelPayment(Payment payment, CreditEntry creditEntry, List<CreditHistory> creditHistoryList, List<String> failureMessages,
    ...
    private void addCreditEntry(Payment payment, CreditEntry creditEntry) {
        creditEntry.addCreateAmount(payment.getPrice());
    }
}
